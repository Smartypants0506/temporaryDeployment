...
# SchoolNest Acceptable Use Policy

**Last updated February 05, 2025**

This Acceptable Use Policy ("Policy") is part of our Terms of Service ("Legal Terms") and should therefore be read alongside our main Legal Terms: [https://schoolnest.org/tos](https://schoolnest.org/tos). If you do not agree with these Legal Terms, please refrain from using our Services. Your continued use of our Services implies acceptance of these Legal Terms.
...
We are SchoolNest ("Company," "we," "us," or "our") a company registered in Wyoming, United States at ADDRESS HERE,, WY. We operate the website [https://schoolnest.org](https://schoolnest.org) (the "Site"), as well as any other related products and services that refer or link to this Policy (collectively, the "Services").
...
- any other content, materials, or data you provide to SchoolNest or use with the Services.
...
- you have firsthand experience with the services and software being reviewed;
...
- breach this Policy, please email us at [schoolnestcontact@gmail.com](mailto:schoolnestcontact@gmail.com), or refer to the contact details at the bottom of this document to let us know which Service, Content, or Contribution is in breach of this Policy and why

- infringe any third-party intellectual property rights, please email us at [schoolnestcontact@gmail.com](mailto:schoolnestcontact@gmail.com)
...
SchoolNest is under no obligation to monitor users’ activities, and we disclaim any responsibility for any user’s misuse of the Services. SchoolNest has no responsibility for any user or other Content or Contribution created, maintained, stored, transmitted, or accessible on or through the Services, and is not obligated to monitor or exercise any editorial control over such material. If SchoolNest becomes aware that any such Content or Contribution violates this Policy, SchoolNest may, in addition to removing such Content or Contribution and blocking your account, report such breach to the police or appropriate regulatory authority. Unless otherwise stated in this Policy, SchoolNest disclaims any obligation to any person who has not entered into an agreement with SchoolNest for the use of the Services.

## HOW CAN YOU CONTACT US ABOUT THIS POLICY?

If you have any further questions or comments or wish to report any problematic Content or Contribution, you may contact us by:

Email: [schoolnestcontact@gmail.com](mailto:schoolnestcontact@gmail.com)
`;
