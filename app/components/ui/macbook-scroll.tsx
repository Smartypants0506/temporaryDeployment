...
export const MacbookScroll = ({
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            setIsMedium(width >= 768 && width < 1400); // Adjust 1024 as needed
        };
    ...
    const scaleX = useTransform(
        scrollYProgress,
        [0, isMobile ? 0.2 : isMedium ? 0.4 : 0.3],
        [1.2, isMobile ? 1 : isMedium ? 1.3 : 1.5]
    );
    
    const scaleY = useTransform(
        scrollYProgress,
        [0, isMobile ? 0.2 : isMedium ? 0.4 : 0.3],
        [0.6, isMobile ? 1 : isMedium ? 1.3 : 1.5]
    );
    
    const translate = useTransform(
        scrollYProgress,
        [0, isMobile ? 0.5 : isMedium ? 0.75 : 1],
        [0, isMobile ? 600 : isMedium ? 800 : 1500]
    );
    
    const rotate = useTransform(
        scrollYProgress,
        [0.1, 0.12, isMobile ? 0.2 : isMedium ? 0.4 : 0.3],
        [-28, -28, 0]
    );
